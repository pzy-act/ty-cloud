...
/**
 * 陶艺作品管理 功能模块 - 取件记录 - 服务接口。
 */
public interface TyArtPickupRecordService {
     ...
     * @return 实体对象
     */
    TyArtPickupRecord getById(Long id);
     ...
     * @return 是否成功
     */
    boolean save(TyArtPickupRecord entity);
     ...
     * @return 是否成功
     */
    boolean updateById(TyArtPickupRecord entity);
