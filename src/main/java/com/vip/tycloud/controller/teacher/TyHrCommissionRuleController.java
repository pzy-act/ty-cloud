...
public class TyHrCommissionRuleController {
     ...
     */
    @PostMapping("/page")
    public ApiResponse<PageResultDTO<TyHrCommissionRuleRespDTO>> page(@Valid @RequestBody PageFilterReqDTO req) {
        PageResultDTO<TyHrCommissionRule> pageResult = tyHrCommissionRuleService.page(req.getPageNumber(), req.getPageSize(), req.getKeyword(), req.getStatus());
