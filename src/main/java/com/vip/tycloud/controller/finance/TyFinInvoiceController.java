...
public class TyFinInvoiceController {
     ...
     */
    @PostMapping("/page")
    public ApiResponse<PageResultDTO<TyFinInvoiceRespDTO>> page(@Valid @RequestBody PageFilterReqDTO req) {
        PageResultDTO<TyFinInvoice> pageResult = tyFinInvoiceService.page(
            req.getPageNumber(),
            req.getPageSize(),
            req.getKeyword(),
            req.getStatus()
